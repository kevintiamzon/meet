...
/**
 * Credentials are those values required to get access to your calendar. If you see
 * "process.env" this means the value is in the "config.json" file. This is a best practice
 * as it keeps your API secrets hidden. Please remember to add "config.json" to "gitignore"
 */
const credentials = {
  ...
  redirect_uris: ["https://kevintiamzon.github.io/meet/"],
  javascript_origins: ["https://kevintiamzon.github.io", "http://localhost:3000"],
};
 ...
 * and be authorized to see your calendar. After logging in, they'll recieve a code as a 
 * parameter.
 */
...
module.exports.getAccessToken = async (event) => {
  ...
  return new Promise((resolve, reject) => {
     ...
     * callback in this case is an arrow function with the results as parameters: "err"/"token"
      */
